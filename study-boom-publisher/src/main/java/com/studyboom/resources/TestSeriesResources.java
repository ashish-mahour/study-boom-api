...
public interface TestSeriesResources {
	...
	@PostMapping(path = "/create/test/series", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<TestSeriesStatusDTO> createTestSeries(@RequestBody TestSeriesDetailsDTO testSeriesDetailsDTO);
	...
	@GetMapping(path = "get/test/series", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<TestSeries>> getTestSeriesById(@RequestParam("publisherId") Long publisherId,
